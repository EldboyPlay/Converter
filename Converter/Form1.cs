...
namespace Converter {
	public partial class Form1 : Form {
		...
		private void историяToolStripMenuItem_Click(object sender, EventArgs e) {
			...
			history.Show();
			if (ctl.his.Count() == 0) {
				MessageBox.Show("История операций пустая!\n\n- Начните работу в приложении чтобы история операций появилась)", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return;
			}
        ...
        private void справкаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            form3.Show(); // Открытие формы 3 без блокировки других окон
        }

        // Место для реализации в будущем новых функций в главной форме
